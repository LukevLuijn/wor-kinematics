...
namespace View
{
    ...
    public:
        ...
        /**
			 *
			 */
        explicit RectangleShape(const Point& aCentrePoint, const std::string& aTitle = "", int aBorderWidth = 2,
                                int aSpacing = 2);
        /**
			 *
			 */
        RectangleShape(Model::ModelObjectPtr aModelObject, const Point& aCentrePoint, const std::string& aTitle = "",
