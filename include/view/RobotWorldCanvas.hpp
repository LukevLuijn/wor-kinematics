...
namespace View
{
	 ...
	 *
	 */
    class RobotWorldCanvas : public ScrolledCanvas, public ViewObject
    {
    public:
        /**
			 *
    ...
    protected:
        ...
        /**
			 *
			 */
        virtual void handleItemMenu(ShapePtr aSelectedShape, const Point& aPoint);
        /**
			 *
			 */
    ...
    private:
        ...
        void remove(const std::vector<std::shared_ptr<T>>& aTs)
        {
            ...
            std::copy_if(shapes.begin(), shapes.end(), std::back_inserter(shapePtrs), [&aTs](ShapePtr aShape) {
                std::shared_ptr<S> shape = std::dynamic_pointer_cast<S>(aShape);
                if (shape)
                {
                    return std::find_if(aTs.begin(), aTs.end(), [shape](std::shared_ptr<T> aT) {
        ...
        void add(const std::vector<std::shared_ptr<T>>& aTs)
        {
            ...
            {
                auto result = std::find_if(shapes.begin(), shapes.end(), [t](ShapePtr aShape) {
