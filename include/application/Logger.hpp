...
namespace Application
{
    ...
    public:
        ...
        template<typename T>
        static void log(const std::string& aMessage, T var, const std::string& func, const std::string& file,
                        int lineNum)
        {
            log(aMessage, std::vector<T>({var}), func, file, lineNum);
        }
        template<typename T>
        static void log(const std::string& aMessage, std::vector<T> vars, const std::string& func,
                        const std::string& file, int lineNum)
        {
