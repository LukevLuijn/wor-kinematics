...
namespace Model
{
	 ...
	 *
	 */
    Wall::Wall(const Point& aPoint1, const Point& aPoint2) : point1(aPoint1), point2(aPoint2)
    {
    }
    /**
	 *
	 ...
	 *
	 */
    void Wall::setPoint1(const Point& aPoint1, bool aNotifyObservers /*= true*/)
    {
        point1 = aPoint1;
	 ...
	 *
	 */
    void Wall::setPoint2(const Point& aPoint2, bool aNotifyObservers /*= true*/)
    {
        point2 = aPoint2;
        if (aNotifyObservers == true)
        {
