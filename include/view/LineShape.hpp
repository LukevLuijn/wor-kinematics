...
namespace View
{
    ...
    public:
        /**
			 *
			 */
        LineShape(RectangleShapePtr aNode1, RectangleShapePtr aNode2, const std::string& aTitle = "",
                  int aLineWidth = 1, int anArrowHeadSize = 10);
        /**
			 *
			 */
        LineShape(Model::ModelObjectPtr aModelObject, RectangleShapePtr aNode1, RectangleShapePtr aNode2,
