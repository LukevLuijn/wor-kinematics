...
namespace Base
{
    ...
    struct NotificationFunctionTypeTraits {
        static void call(const NotificationFunction& aNotificationFunction, NotifyEvent&)
        {
    ...
    struct NotificationFunctionTypeTraits<std::function<void(NotifyEvent&)>> {
        static void call(const std::function<void(NotifyEvent&)>& aNotificationFunction, NotifyEvent& event)
        {
