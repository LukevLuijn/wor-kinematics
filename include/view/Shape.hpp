...
namespace View
{
    ...
    public:
        /**
			 *
			 */
        Shape() : ViewObject(), data(nullptr), selected(false)
        {
        }
        /**
			 *
			 */
        explicit Shape(Model::ModelObjectPtr aModelObject) : ViewObject(aModelObject), data(nullptr), selected(false)
        {
        ...
        /**
			 ...
			 */
        virtual void setSelectedAt(const Point& aPoint = DefaultPosition, bool aSelected = true)
        {
            UNUSEDCAST(aPoint);
