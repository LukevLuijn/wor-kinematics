    ...
    struct Message {
        ...
        struct MessageHeader {
            /**
					 *
					 */
            MessageHeader() : messageType(0), messageLength(0)
            {
            }
            /**
					 *
            ...
            MessageHeader(char aMessageType, unsigned long aMessageLength)
                : messageType(aMessageType), messageLength(aMessageLength)
            {
            }
            /**
					 *
					 ...
					 */
            explicit MessageHeader(const std::string& aMessageHeaderBuffer) : messageType(0), messageLength(0)
            {
            ...
            std::string toString() const
            {
                ...
                os << magicNumber1 << magicNumber2 << magicNumber3 << magicNumber4 << majorVersion << minorVersion
                   << std::setw(charWidth) << static_cast<int>(messageType) << std::setw(intWidth) << messageLength;
                return os.str();
            }
            /**
            ...
            void fromString(const std::string& aString)
            {
                ...
                char major;
                char minor;
                is >> magic[0] >> magic[1] >> magic[2] >> magic[3] >> major >> minor >> std::setw(charWidth) >>
                        reinterpret_cast<int&>(messageType) >> std::setw(intWidth) >> messageLength;
            }
            /**
            ...
            {
                std::ostringstream os;
                os << magicNumber1 << magicNumber2 << magicNumber3 << magicNumber4 << " " << majorVersion << " "
                   << minorVersion << " " << static_cast<int>(messageType) << " " << messageLength;
                return os.str();
            }
            /**
					 *
        ...
        /**
			 ...
			 * @param aMessageType
			 */
        explicit Message(char aMessageType) : messageType(aMessageType)
        {
        }
        /**
			 *
			 ...
			 */
        Message(char aMessageType, const std::string& aMessage) : messageType(aMessageType), message(aMessage)
        {
        }
        /**
			 *
			 * @param aMessage
			 */
        Message(const Message& aMessage) : messageType(aMessage.messageType), message(aMessage.message)
        {
        }
        /**
			 *
