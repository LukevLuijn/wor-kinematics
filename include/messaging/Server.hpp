...
namespace Messaging
{
    ...
    public:
        /**
			 *
			 */
        Server(unsigned short aPort, RequestHandlerPtr aRequestHandler);
        /**
			 *
			 */
        virtual ~Server();
    ...
    private:
        /**
			 *
			 */
        void handleAccept(ServerSession* aSession, const boost::system::error_code& error)
        {
            if (!error)
            {
            ...
            else
            {
                ...
                if (!stopAccepting && error != boost::asio::error::basic_errors::operation_aborted)
                {
                    ...
                    os << "************ " << __PRETTY_FUNCTION__ << ": " << error.message()
