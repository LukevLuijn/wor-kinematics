...
namespace Base
{
	 ...
	 *
	 */
    Trace::Trace(const std::string& aText, long aLineNumber /* = 0 */, bool withTimeStamp /* = false */,
                 bool aTraceCDtor /* = true*/)
        : traceText(aText), traceTimeStamp(withTimeStamp), traceCDtor(aTraceCDtor)
    {
        if (traceCDtor == true)
        {
	 ...
	 *
	 */
    Trace::Trace(const std::string& aText1, const std::string& aText2, long aLineNumber /* = 0 */,
                 bool withTimeStamp /* = false */, bool aTraceCDtor /* = true*/)
        : traceText(aText1 + " " + aText2), traceTimeStamp(withTimeStamp), traceCDtor(aTraceCDtor)
    {
        if (traceCDtor == true)
        {
            traceConstructor(aLineNumber);
	 ...
	 *
	 */
    /* static */ void Trace::trace(const std::string& aText, bool withTimeStamp /* = Trace::isTimeStampEnabled() */)
    {
	 ...
	 *
	 */
    /* static */ void Trace::trace(const std::string& aText, const char* aFunctionName, long aLineNumber,
